...
import Elbow_plank_backend

def app():
    st.markdown(
        """
        <h1 style="color:#05757d;">Elbow Plank Tracker</h1>
    ...
    st.markdown(
        ...
        <div style="border: 2px solid #e0e0e0; padding: 20px; background-color: #f9f9f9; border-radius: 10px; margin-bottom: 20px;">
            <h3 style="font-size: 18px; color: #05757d; font-weight: bold;">Real-Time Elbow Plank Tracker</h3>
        ...
        st.markdown(
            ...
            <div style="border: 2px solid #e0e0e0; padding: 20px; background-color: #f9f9f9; border-radius: 10px; height: 100%;">
                ...
                <div style="text-align: center;">
                    <img src="https://img.youtube.com/vi/qmw7-IFVZPo/hqdefault.jpg" class="video-thumbnail" style="width: 100%; height: auto; border-radius: 10px; margin-bottom: 10px;" />
                    <a href="https://www.youtube.com/watch?v=qmw7-IFVZPo" target="_blank" class="video-title" style="font-size: 14px; font-weight: bold; color: #4f0f62; text-decoration: none; display: block; margin-top: 10px;">Reps Tutorial</a>
                </div>
            </div>
            """, unsafe_allow_html=True)
    ...
    if start_coach_button:
        ...
        Elbow_plank_backend.process_video(level)

    if stop_coach_button:
        st.session_state.start_coach = False
        Elbow_plank_backend.stop_video()
